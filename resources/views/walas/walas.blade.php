                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Konsultan</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        40
                                    </h5>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <p class="mb-5">"life" (kehidupan) dan "guidance" (panduan) untuk menyoroti peran
                                        layanan BK dalam membantu individu mengatasi tantangan dan mengarahkan kehidupan
                                        mereka.</p>
