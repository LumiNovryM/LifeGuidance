    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('guru_store_bimbingan_sosial') }}" method="post" class="mt-2">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Orang Yang Bersangkutan</label>
                        <select name="diajukan" id="" class="form-control">
                            @foreach ($names as $name)
                                <option value="{{ $name->id }}">{{ $name->name }}, {{ $name->kelas->name }}
                                </option>
                            @endforeach
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" name="lokasi_pertemuan"
                            placeholder="Masukkan Lokasi Pertemuan" autocomplete="off">
