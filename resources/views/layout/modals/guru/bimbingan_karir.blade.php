    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('guru_store_bimbingan_karir') }}" method="post" class="mt-2">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Tipe Bimbingan</label>
                        <select name="tipe_bimbingan" id="" class="form-control">
