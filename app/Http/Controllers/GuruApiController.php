...
class NoTokenApiController extends Controller
{
    ...
    {
        $datas = Bimbingan_Pribadi::with('siswa', 'guru', 'walas', 'kelas')->where('guru_id', $id)->get();
        if ($datas) {
    ...
    {
        $datas = Bimbingan_Belajar::with('siswa', 'guru', 'walas', 'kelas')->where('guru_id', $id)->get();
        if ($datas) {
            return ApiFormatter::createApi(200, 'Success', $datas);
        } else {
            return ApiFormatter::createApi(400, 'Failed');
    ...
    {
        $datas = Bimbingan_Sosial::with('siswa', 'guru', 'walas', 'kelas')->where('guru_id', $id)->get();
        if ($datas) {
            return ApiFormatter::createApi(200, 'Success', $datas);
        } else {
            return ApiFormatter::createApi(400, 'Failed');
    ...
    {
        $datas = Bimbingan_Karir::with('siswa', 'guru', 'walas', 'kelas')->where('guru_id', $id)->get();
        if ($datas) {
            return ApiFormatter::createApi(200, 'Success', $datas);
        } else {
            return ApiFormatter::createApi(400, 'Failed');
    ...
    public function count_bimbingan_pribadi($id) {
        $datas = Bimbingan_Pribadi::where('guru_id', $id)->get();
        $count = $datas->count();
    ...
    public function count_bimbingan_belajar($id) {
        $datas = Bimbingan_Belajar::where('guru_id', $id)->get();
        $count = $datas->count();
    ...
    public function count_bimbingan_sosial($id) {
        $datas = Bimbingan_Sosial::where('guru_id', $id)->get();
        $count = $datas->count();
    ...
    public function count_bimbingan_karir($id) {
        $datas = Bimbingan_Karir::where('guru_id', $id)->get();
        $count = $datas->count();
